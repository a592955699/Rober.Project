...
namespace Rober.WebApp.Framework.TagHelpers.Shared
{
    ...
    public class JmDatePickerTagHelper : TagHelper
    {
        ...
        public JmDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
