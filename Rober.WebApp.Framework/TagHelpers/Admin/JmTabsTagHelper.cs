...
namespace Rober.WebApp.Framework.TagHelpers.Admin
{
    ...
    /// jm-tabs tag helper
    /// </summary>
    [HtmlTargetElement("jm-tabs", Attributes = IdAttributeName)]
    public class JmTabsTagHelper : TagHelper
    {
        ...
        public JmTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //create context item
            var tabContext = new List<JmTabContextItem>();
            context.Items.Add(typeof(JmTabsTagHelper), tabContext);
    ...
    /// "jm-tab tag helper
    /// </summary>
    [HtmlTargetElement("jm-tab", ParentTag = "jm-tabs", Attributes = NameAttributeName)]
    public class JmTabTagHelper : TagHelper
    {
        ...
        /// </summary>
        /// <param name="htmlHelper">HTML helper</param>
        public JmTabTagHelper(IHtmlHelper htmlHelper)
        {
            _htmlHelper = htmlHelper;
        }
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<JmTabContextItem>)context.Items[typeof(JmTabsTagHelper)];
            tabContext.Add(new JmTabContextItem()
            {
