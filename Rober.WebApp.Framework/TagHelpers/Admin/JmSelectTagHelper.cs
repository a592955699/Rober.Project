...
namespace Rober.WebApp.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("jm-select", TagStructure = TagStructure.WithoutEndTag)]
    public class JmSelectTagHelper : TagHelper
    {
        ...
        public JmSelectTagHelper(IHtmlHelper htmlHelper)
        {
