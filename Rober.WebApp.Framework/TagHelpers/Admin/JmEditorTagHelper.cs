...
namespace Rober.WebApp.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("jm-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class JmEditorTagHelper : TagHelper
    {
        ...
        public JmEditorTagHelper(IHtmlHelper htmlHelper)
        {
