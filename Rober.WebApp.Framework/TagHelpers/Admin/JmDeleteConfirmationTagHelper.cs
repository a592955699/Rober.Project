...
namespace Rober.WebApp.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("jm-delete-confirmation", Attributes = ModelIdAttributeName + "," + ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class JmDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public JmDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
