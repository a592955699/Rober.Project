...
namespace Rober.WebApp.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("jm-action-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class JmActionConfirmationTagHelper : TagHelper
    {
        ...
        public JmActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
