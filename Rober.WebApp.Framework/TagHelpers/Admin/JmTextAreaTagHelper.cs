...
namespace Rober.WebApp.Framework.TagHelpers.Admin
{
    ...
    /// </summary>
    [HtmlTargetElement("jm-textarea", Attributes = ForAttributeName)]
    public class JmTextAreaTagHelper : TextAreaTagHelper
    {
        ...
        public JmTextAreaTagHelper(IHtmlGenerator generator) : base(generator)
        {
        }
