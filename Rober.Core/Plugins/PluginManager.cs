...
using Rober.Core.ComponentModel;
...
namespace Rober.Core.Plugins
{
    ...
    public class PluginManager
    {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug, ApplicationPartManager applicationPartManager, JmConfig config)
        {
        ...
        /// <param name="applicationPartManager">Application part manager</param>
        /// <param name="config">Config</param>
        public static void Initialize(ApplicationPartManager applicationPartManager, JmConfig config)
        {
